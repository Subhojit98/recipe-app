...
const sideBar = () => {
    return (
        <>
            ...
            <aside id="default-sidebar" className="hidden relative top-0 lg:block w-72 h-full transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
                <div className="h-full px-3 py-4 overflow-y-auto bg-white dark:bg-gray-800">
                    ...
                    <input type="search" placeholder="Search" className="py-3 outline-none px-4 border mt-4 border-neutral-700" />
                    ...
                    <div className="mt-14 mb-10 flex gap-5 justify-center">
                        ...
                        <Button variant="destructive" className="rounded-lg">Clear </Button>
