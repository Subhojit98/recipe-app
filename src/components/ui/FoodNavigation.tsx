; const FoodNavigation = () => {
    return (
        <>
            <div className="w-full h-[7vh] lg:h-[9vh] flex items-center justify-center">
                <nav>
                    <ul className="flex gap-5 mobileScreen:gap-14 md:gap-20 lg:gap-32 text-sm md:text-base text-gray-500 font-semibold relative border-b-[1px] border-neutral-400">
